...
void getName(struct Name* name) {
	...
	if ( yes() == 1 ) {
        ...
        name->middleInitial[0] = '\0'; // Set the middle initial to nothing.
...
void getNumbers(struct Numbers* numbers) {
	...
	if ( yes() == 1 ) {
        ...
        numbers->home[0] = '\0'; // Set the home phone number to nothing.
	}
	...
	if ( yes() == 1 ) {
        ...
        numbers->business[0] = '\0'; // Set the business phone number to nothing.
	}
}
